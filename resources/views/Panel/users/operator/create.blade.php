...
@section('main')
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                <h2 class="text-xl font-semibold text-gray-700">Tambah Departemen</h2>
            </div>
        ...
        <div class="bg-white shadow-md rounded-md p-6">
            ...
            <form action="{{ route('store.op') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div>
                    <label for="NamaOperatorDepartemen" class="block text-sm font-medium text-gray-700 mb-1">Nama
                        Operator</label>
                    <input type="text" name="NamaOperatorDepartemen" id="NamaOperatorDepartemen" value=""
                ...
                <div>
                    <label for="ID_Departemen" class="block text-sm font-medium text-gray-700 mb-1">Kategori</label>
