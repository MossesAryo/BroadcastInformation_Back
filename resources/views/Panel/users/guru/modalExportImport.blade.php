                ...
                <div class="mt-4">
                    ...
                    <div id="exportContent" class="tab-content">
                        <div class="space-y-3">
                            ...
                            <button onclick="window.location='{{ route('export.excel.guru') }}'" class="w-full flex items-center justify-center px-4 py-3 border border-green-300 rounded-md bg-green-50 hover:bg-green-100 text-green-700 transition-colors">
