...
@section('main')
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="bg-white shadow-md rounded-md p-6">
            ...
            <form action="{{ route('departemen.update', $departemen->ID_Departemen) }}" method="POST" class="space-y-6">
                @csrf
                @method('put')
                ...
                <div>
                    <label for="Nama_Departemen" class="block text-sm font-medium text-gray-700 mb-1">Nama
                        Departemen</label>
                    <input type="text" name="Nama_Departemen" id="Nama_Departemen" value="{{ $departemen->Nama_Departemen }}"
