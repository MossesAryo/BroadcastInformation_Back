...
@section('scripts')
    <script>
        // Add this script to your siswa.blade.php file
        ...
        `;
                ...
                fetch(
                    ...
                    .then(data => {
                        ...
                        updateTable(data.siswa.data);

                        // Update pagination
                        if (paginationContainer) {
                            updatePagination(data.siswa);
                        }

                        // Update mobile pagination
                        if (mobilePagination) {
                            updateMobilePagination(data.siswa);
                        }

                        // Update results info
                        if (resultsInfo) {
                            updateResultsInfo(data.siswa);
                        }
            ...
            `;
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        <div class="flex space-x-2">
                            <button title="Edit" onclick="window.location='${window.location.origin}/siswa/edit/${item.ID_Siswa}/${item.username}'">
        ...
        `;
            ...
            const searchForm = document.querySelector('form[action*="siswa"]');
            if (searchForm) {
