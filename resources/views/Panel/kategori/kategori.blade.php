            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Pemberitahuan</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">...</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">25 Apr 2025</td>
                    ...
                    <!-- Row 2: Published Status -->
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">2</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Akademik</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">.....</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">23 Apr 2025</td>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Acara</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">....</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">20 Apr 2025</td>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Berita</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">....</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">20 Apr 2025</td>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Penghargaan</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">....</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">20 Apr 2025</td>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Fasilitas</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">....</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">20 Apr 2025</td>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Keagamaan</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">....</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">20 Apr 2025</td>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Kesehatan</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">....</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">20 Apr 2025</td>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Darurat</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">....</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">20 Apr 2025</td>
