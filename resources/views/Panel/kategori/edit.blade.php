...
@section('main')
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                <h2 class="text-xl font-semibold text-gray-700">Edit Kategori Informasi
        ...
        <div class="bg-white shadow-md rounded-md p-6">
            ...
            <form action="{{ route('kategori.update', $kategori->IDKategoriInformasi) }}" method="POST" class="space-y-6">
                @csrf
                @method('put')
