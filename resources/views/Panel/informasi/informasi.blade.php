...
@section('main')
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <button class="bg-teal-500 hover:bg-teal-600 text-white px-4 py-2 rounded-md flex items-center" onclick="window.location='{{ route('create.info') }}'">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $item->kategori->NamaKategori }}</td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            <div class="flex space-x-2">
                                ...
                                <button class="text-red-600 hover:text-red-900" title="Delete" onclick="openDeleteModal('{{ $item->IDInformasi }}')">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
